...
(function( root, factory ) {
    ...
    define('widgets/filednd',[
         ...
         * @description 阻止此事件可以拒绝某些类别的文件拖入进来。目前只有 chrome 提供这样的 API，且只能通过 mime-type 验证。
         * @for  Uploader
         */
    ...
    define('widgets/filepicker',[
        ...
        $.extend( Uploader.options, {
             ...
             * @namespace options
             * @for Uploader
             * @description 指定接受哪些类别的文件。 由于目前还有ext转mimeType表，所以这里需要分开指定。
             *
             * * `title` {String} 文字描述
    ...
    define('file',[
        ...
        function WUFile( source ) {
            ...
            /**
             * 文件MIMETYPE类别，与文件类别的对应关系请参考[http://t.cn/z8ZnFny](http://t.cn/z8ZnFny)
             * @property type
             * @type {string}
             * @default 'application'
             */
    ...
    define('queue',[
        ...
        $.extend( Queue.prototype, {
            ...
            /**
             * 获取指定类别的文件列表, 列表中每一个成员为[File](#WebUploader:File)对象。
    ...
    define('widgets/queue',[
        ...
        return Uploader.register({
            ...
            _addFile: function( file ) {
                ...
                // 不过类别判断允许不允许，先派送 `beforeFileQueued`
    ...
    define('widgets/upload',[
        ...
        Uploader.register({
             ...
             * @description 当某个文件上传到服务端响应后，会派送此事件来询问服务端响应是否有效。如果此事件handler返回值为`false`, 则此文件将派送`server`类别的`uploadError`事件。
             * @for  Uploader
             */
