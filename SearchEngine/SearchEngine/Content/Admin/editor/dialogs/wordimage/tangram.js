...
/**
 * 对语言层面的封装，包括类别判断、模块扩展、继承基类以及对象自定义事件的支持。
 ...
 * @param {Object} 	options.vars 				要传递给flash的参数，支持JSON或string类别。
 * 
 ...
 * @remark
 * 1、与callByServer不同，callback参数只支持Function类别，不支持string。
